...
This mechanism has been integrated into Bitcore-Node-DashFirst which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashfirstcoin/insight-api-dashfirst#web-socket-api](https://github.com/dashfirstcoin/insight-api-dashfirst#web-socket-api) 
* API: [https://github.com/dashfirstcoin/insight-api-dashfirst#instantsend-transactions](https://github.com/dashfirstcoin/insight-api-dashfirst#instantsend-transactions) 
...
By default, the DashFirst Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DashFirst Core daemon:
