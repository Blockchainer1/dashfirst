...
DashFirst Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as DashFirst Core, where everyone uses
...
pay attention to for reviewers of DashFirst Core code.

General DashFirst Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: DashFirst Core uses tinyformat, which is type safe. Leave them out to avoid confusion
