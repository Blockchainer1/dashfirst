...
Only requiring some minor changes is dashfirst.cpp.
...
Changes to dashfirst.cpp
----------------------
dashfirst.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
