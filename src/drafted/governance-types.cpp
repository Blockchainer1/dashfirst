...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DashFirstNetwork") type = DashFirstNetwork;
    if(strType == "DashFirstNetworkVariable") type = DashFirstNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DashFirstNetwork) s = "DashFirstNetwork";
    if(type == DashFirstNetworkVariable) s = "DashFirstNetworkVariable";
