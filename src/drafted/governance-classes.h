 ...
 *
 *   // network
 *   CDashFirstNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.dashfirst.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDashFirstNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CDashFirstNetwork(UniValue objIn)
    {
...
// // can be under: DashFirstNetwork
// //   -- signature requirements : Key1(User)
// class CDashFirstNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == DashFirstNetwork);
//     // }
