...
2. run dashfirstd with -printalert or -sendalert like this:
   /path/to/dashfirstd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.dashfirst.site";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/DashFirst Core:0.12.0.58/"));
