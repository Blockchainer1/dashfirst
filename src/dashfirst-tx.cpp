...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("DashFirst Core dashfirst-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dashfirst-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dashfirst transaction") + "\n" +
              "  dashfirst-tx [options] -create [commands]   " + _("Create hex-encoded dashfirst transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dashfirst transaction
