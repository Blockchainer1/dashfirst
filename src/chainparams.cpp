...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 1000000; // one year
        ...
        genesis = CreateGenesisBlock(1571481176, 1304338, 0x1e0ffff0, 1, 50 * COIN);
        ...
        // DashFirst BIP44 coin type is '5'
        ...
        checkpointData = (CCheckpointData) {
            ...
            (    0, uint256S("0x00000cb74197944bdb61b7adcd87fc6754cc1434fa924240fe7e4a29b1aba223")),
            1532614049, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1532614050, 1435665, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
*/
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000003e370fbc988a23d52558e7550ea730a220edbada643f5adaf2948b68316"));
        assert(genesis.hashMerkleRoot == uint256S("0x80f88814431479eced728caedbd2d70ab468a1379238d0775d066d0d5ff4d98d"));

        vFixedSeeds.clear();
        vSeeds.clear();

        // Testnet DashFirst addresses start with 'u'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,130);
        // Testnet DashFirst script addresses start with 'v'
        ...
        // Testnet DashFirst BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet DashFirst BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet DashFirst BIP44 coin type is '1' (All coin's testnet default)
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x000003e370fbc988a23d52558e7550ea730a220edbada643f5adaf2948b68316")),

            1532614050, // * UNIX timestamp of last checkpoint block
            0,     // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1532614051, 307313, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
	...
	// calculate Genesis Block
        ...
        */
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000005e9241d5294ab2fe14a23a0509848a8359849068afaf4ff872ac0a14f9a"));
        assert(genesis.hashMerkleRoot == uint256S("0x80f88814431479eced728caedbd2d70ab468a1379238d0775d066d0d5ff4d98d"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x000005e9241d5294ab2fe14a23a0509848a8359849068afaf4ff872ac0a14f9a")),
            0,
            0,
            0
        };
        // Regtest DashFirst addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest DashFirst script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,20);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest DashFirst BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest DashFirst BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest DashFirst BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80)(0x00)(0x00)(0x01).convert_to_container<std::vector<unsigned char> >();
   }
};
