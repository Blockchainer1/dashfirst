...
{
    if(fLiteMode) return; // ignore all DashFirst related functionality
...
/*
    ...
    allow endless transaction that would bloat DashFirst and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("dashfirst-privatesend");
