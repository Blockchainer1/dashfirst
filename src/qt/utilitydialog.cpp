    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("DashFirst Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About DashFirst Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dashfirst-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the DashFirst in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DFCN, 0.1 DFCN, 1 DFCN and 10 DFCN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://dashfirstcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://dashfirstcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("DashFirst Core is shutting down...") + "<br /><br />" +
