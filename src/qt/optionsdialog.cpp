    ...
    mapper(0)
{
    ...
    /* Theme selector */
    /*ui->theme->addItem(QString("DFCN-light"), QVariant("light"));*/
    ui->theme->addItem(QString("DFCN-blue"), QVariant("drkblue"));
    /*ui->theme->addItem(QString("DFCN-Crownium"), QVariant("crownium"));*/
    ui->theme->addItem(QString("DFCN-traditional"), QVariant("trad"));
