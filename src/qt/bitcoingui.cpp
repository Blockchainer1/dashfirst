    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("DashFirst Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DashFirst address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dashfirst: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About DashFirst Core"), this);
    aboutAction->setStatusTip(tr("Show information about DashFirst Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DashFirst Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DashFirst addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DashFirst addresses"));
    ...
    openAction->setStatusTip(tr("Open a dashfirst: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DashFirst Core help message to get a list with possible DashFirst Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("DashFirst Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DashFirst network", "", count));
}
...
{
    QString strTitle = tr("DashFirst Core"); // default title
    ...
    // Append title to "DashFirst Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
